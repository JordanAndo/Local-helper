...
const HomeScreen = () => {
  ...
  const popularServicesData = [
    { id: '1', title: 'floor Cleaning', image: require('../assets/image/cleaning1.png'), screen: 'CleaningService' },
    { id: '2', title: 'Room Cleaning', image: require('../assets/image/cleaning2.png'), screen: 'CleaningService' },
    { id: '3', title: 'Bathroom Cleaning', image: require('../assets/image/cleaning4.png'), screen: 'CleaningService' },
  ];

  const categoriesData = [
    { id: '1', title: 'Cleaning', icon: 'cleaning-services', color: '#4CAF50', screen: 'CleaningService' },
    { id: '2', title: 'Repairing', icon: 'build', color: '#FF9800', screen: 'RepairingService' },
    { id: '3', title: 'Plumbing', icon: 'water', color: '#2196F3', screen: 'PlumbingService' },
    { id: '4', title: 'Painting', icon: 'brush', color: '#9C27B0', screen: 'PaintingService' },
  ];
